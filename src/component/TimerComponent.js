...
const TimerComponent = ({timeMax, timeMin, goToNextPage, setTimingFullfilledFlag}) => {
  ...
  return (
    <div className='timer'>
      <p>Please finish all the questions in this page within <b>{parseInt(timeMax/60)} minutes and {parseInt(timeMax%60)} seconds</b>. </p>
      {(timeMin>0) && <p>Please spend <b>at least</b> <b>{parseInt(timeMin/60)} minutes and {parseInt(timeMin%60)} seconds</b> to finish the questions in this page. </p>}
